...
Šablona obsahuje loga a barvy všech fakult. Pro změnu stačí nahradit zkratku fakulty v příkazu **\newcommand{\faculty}{_DFJP_}** zkratkou jiné (z výběru: _DFJP_, _FEI_, _FCHT_, _FES_, _FR_, _FZS_, _FF_ a _UPA_). Navíc je většina prvků parametrizovaná, lze tak snadno měnit velikost a orientaci posteru, zoomovat text, upravovat velikosti jednotlivých _oken/kapitol_ obsahu a další.
